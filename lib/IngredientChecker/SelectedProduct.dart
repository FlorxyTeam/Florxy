...
// antimicrobial/antibacterial -> Antibacterial
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      extendBodyBehindAppBar: Loading?false:true,
          ...
          child: Column(
            ...
            child: Row(
              ...
              children: [
                ...
                SizedBox(width: 5),
                Inter(text: 'Checking Ingredients...', size: 15, color: Colors.black, fontWeight: f.semiBold),
              ],
            ),
        ),
      ),
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 10 ),
                    PoppinsLeft_Crop(text: 'Moisturizer', size: 18, color: c.textBlack, fontWeight: f.semiBold),
                  ],
                ),
                SizedBox(height: 15),
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 10 ),
                    PoppinsLeft_Crop(text: 'Antibacterial', size: 18, color: c.textBlack, fontWeight: f.semiBold),
                  ],
                ),
                SizedBox(height: 15),
