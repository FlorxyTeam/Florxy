...
class _MentionPostState extends State<MentionPost> {
  ...
  FavPostState _favPostState = FavPostState();
  bool isFav = false;
  List myfav = [];
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: IconButton(
                        onPressed: () {
                          ModalBottomSheetPost.Dialog_Settings(context, widget.username!, myusername!, widget.id!);
                        },
                        alignment: Alignment.topRight,
                      ...
                      children: [
                        ...
                        if(isFav == false)InkWell(
                            onTap: () async {
                              ...
                              // _favPostState.fetchData(myprofileModel.id!);
                              // _favPostState.initState();
                              setState(() {
                                countFav+=1;
                                isFav = true;
                              });
